...
\hline \multicolumn{1}{l}{\textit{\textbf{B2M}}} & \multicolumn{7}{l}{\textit{$ \beta $2-microglobulin}, a reference gene that encodes a protein associated with MHC\footnote{The major histocompatibility complex}} \\ 
